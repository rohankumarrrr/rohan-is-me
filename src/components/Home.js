    ...
    <div className="container" ref={ref}>
      ...
      >
        <div className="text-container">
          ...
          <motion.p style={{ marginTop: '2vh' }} variants={itemVariants}>
            i'm currently a software engineering intern at <a className="inline-link" href="https://medium.com/pinterest-engineering" target="_blank" rel="noopener noreferrer">pinterest</a>, building ai agents to proactively surface, investigate, and remediate security threats across pinterest's source code. prior to this, i was on <a className="inline-link" href="https://music.amazon.com/" target="_blank" rel="noopener noreferrer">amazon music</a>'s sequencing and alexa voice recommendations team, where i introduced language-affinity components into the music recommendation reinforcement learning pipeline, improving linguistic diveristy and recommendation accuracy for multilingual users.
          </motion.p>
          <motion.p style={{ marginTop: '2vh' }} variants={itemVariants}>
