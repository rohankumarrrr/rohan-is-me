  ...
  return (
    <div className="container">
        <div className="content">
          <motion.div style={{paddingTop: '10%'}}>
            <div style={{flexDirection: 'row', verticalAlign: "bottom", display: "inline-flex", height: '6rem'}}>
            ...
            <motion.h1  initial = {{ opacity: 0, y: 100 }} animate = {{ opacity: 1, y: 0 }} transition = {{ duration: 1.5, ease: "backIn", type: "spring", bounce: 0.5}} style={{fontFamily: "Digitag", marginLeft: '1rem', marginTop: '2.5rem'}}>Rohan</motion.h1>
            </div>
            ...
            <motion.div initial = {{ opacity: 0, y: 100 }} animate = {{ opacity: 1, y: 0 }} transition = {{ duration: 1.5, ease: "backIn", type: "spring", bounce: 0.5, delay: 0.25}}>
                <LastListened />
            </motion.div>
          ...
          <motion.div className="image-container" initial={{opacity: 0, x: 500}} animate={{opacity: 1, x: 0}} transition={{duration: 2, ease: "circOut", type: "spring", bounce: 0.3, delay: 0.5}} whileHover={{scale: 0.8}} onHoverStart={() => setShowExperience(true)} onHoverEnd={() => setShowExperience(false)}>
            ...
            <motion.div className="uiuc-container" key="animation-on-state" initial={false} variants={variantsUIUC} animate={showExperience ? 'show' : 'hide'} whileHover={{scale: 1.1}} whileTap={{scale: 0.9}} onClick={() => uiucContainerHeight == "12rem" ? setUiucContainerHeight("7.5rem") : setUiucContainerHeight("12rem")} style={{height: uiucContainerHeight, transition: "height 0.5s ease-out"}}>
                ...
                <Icon icon={"ic:baseline-play-arrow"} className="dropdown-arrow" style={{transform: uiucContainerHeight == "12rem" ? "rotate(90deg)" : "none"}}/>
            </motion.div>
            ...
            <motion.div className="experience1-container" key="animation-on-state" initial={false} variants={variantsExperience1} animate={showExperience ? 'show' : 'hide'} whileHover={{scale: 1.1}} whileTap={{scale: 0.9}} onClick={() => experience1ContainerHeight == "30rem" ? setExperience1ContainerHeight("7rem") : setExperience1ContainerHeight("30rem")} style={{height: experience1ContainerHeight, transition: "height 0.5s ease-out"}}>
                ...
                <Icon icon={"ic:baseline-play-arrow"} className="dropdown-arrow" style={{transform: experience1ContainerHeight == "30rem" ? "rotate(90deg)" : "none"}}/>
            </motion.div>
            ...
            <motion.div className="experience2-container" key="animation-on-state" initial={false} variants={variantsExperience2} animate={showExperience ? 'show' : 'hide'} whileHover={{scale: 1.1}} whileTap={{scale: 0.9}} onClick={() => experience2ContainerHeight == "23rem" ? setExperience2ContainerHeight("6.5rem") : setExperience2ContainerHeight("23rem")} style={{height: experience2ContainerHeight, transition: "height 0.5s ease-out"}}>
                ...
                <p className="experience-p">Conducted unit and automated testing using MSTest and Azure Pipeline to ensure proper API functionality and
...
business executives.</p>
                <Icon icon={"ic:baseline-play-arrow"} className="dropdown-arrow" style={{transform: experience2ContainerHeight == "23rem" ? "rotate(90deg)" : "none"}}/>
            </motion.div>
            ...
            <motion.div className="experience3-container" key="animation-on-state" initial={false} variants={variantsExperience3} animate={showExperience ? 'show' : 'hide'} whileHover={{scale: 1.1}} whileTap={{scale: 0.9}} onClick={() => experience3ContainerHeight == "19rem" ? setExperience3ContainerHeight("6.5rem") : setExperience3ContainerHeight("19rem")} style={{height: experience3ContainerHeight, transition: "height 0.5s ease-out"}}>
