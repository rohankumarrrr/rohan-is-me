    ...
    <header className="header">
        <motion.div className="contacts-container" key="animation-on-state" variants={variantsContacts} animate={contactContainerVisible ? 'show' : 'hide'}>
            <motion.a href="mailto:rohankumarrr313@gmail.com" target="_blank" whileHover={{ scale: 1.05 }} whileTap ={{ scale: 0.95 }}>
                <img alt="Mail Logo" className="contact-logo-container" src="https://icons.veryicon.com/png/o/miscellaneous/practical-life-icon/mail-255.png" style={{width: "2.2rem", height: "3.8rem"}}></img>
            </motion.a>
            <motion.a href="https://github.com/rohankumarrrr" target="_blank" whileHover={{ scale: 1.05 }} whileTap ={{ scale: 0.95 }}>
                <img alt="GitHub Logo" className="contact-logo-container" style={{width: "2rem", height: "2rem", marginLeft: "0.9rem"}} src={'https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg'}></img>
            </motion.a>
            <motion.a href="https://linkedin.com/in/rohankumarrr313" target="_blank" whileHover={{ scale: 1.05 }} whileTap ={{ scale: 0.95 }}>
                <img alt="LinkedIn Logo" className="contact-logo-container" src="https://img.icons8.com/ios11/512/linkedin.png" style={{width: "2.7rem", height: "2.5rem", marginTop: "0.2rem", marginLeft: "0.65rem"}}></img>
            </motion.a>
